...
<?
   ...
   $result=mysql_query("SELECT COUNT(itemid) FROM items",$db);
...
href=\"$PHP_SELF?sort=$sort&lower=$lower&number=$number&desc=$desc&keyword=$keyword&search=$search\">back</a>";
    ...
    // print the list if there is not editing
     ...
     $result = mysql_query("SELECT *,DATE_FORMAT(order_date,'%m/%d/%y') AS date FROM sales_items,items,sales_orders WHERE
sales_items.itemid=items.itemid AND sales_orders.salesorderid=sales_items.salesorderid AND items.quantity<1 
ORDER BY sales_orders.order_date LIMIT $lower, $number",$db);
...
<a href=\"$PHP_SELF?sort=itemid&lower=$lower&number=$number&desc=$desc\">ItemID</a></td>
             <td><font color=\"ffffff\">
<a href=\"$PHP_SELF?sort=category&lower=$lower&number=$number&desc=$desc\">Category</a></td>
             <td><font color=\"ffffff\">
<a href=\"$PHP_SELF?sort=format&lower=$lower&number=$number&desc=$desc\">Format</a></td>
             <td><font color=\"ffffff\">
<a href=\"$PHP_SELF?sort=artist&lower=$lower&number=$number&desc=$desc\">Artist</a></td> 
             <td><font color=\"ffffff\">
<a href=\"$PHP_SELF?sort=title&lower=$lower&number=$number&desc=$desc\">Title</a></td>
             <td><font color=\"ffffff\">
<a href=\"$PHP_SELF?sort=label&lower=$lower&number=$number&desc=$desc\">Label</a></td>
             <td><font color=\"ffffff\">
<a href=\"$PHP_SELF?sort=catalog&lower=$lower&number=$number&desc=$desc\">Catalog</a></td>
             <td><font color=\"ffffff\">
<a href=\"$PHP_SELF?sort=condition&lower=$lower&number=$number&desc=$desc\">Cond</a></td>
             <td><font color=\"ffffff\">
...
<a href=\"$PHP_SELF?sort=cost&lower=$lower&number=$number&desc=$desc\">Cost</a></td>
             <td><font color=\"ffffff\">
<a href=\"$PHP_SELF?sort=quantity&lower=$lower&number=$number&desc=$desc\">#</a></td>
             <td><font color=\"ffffff\">
<a href=\"$PHP_SELF?sort=retail&lower=$lower&number=$number&desc=$desc\">Retail</a></td>
             <td><font color=\"ffffff\">
<a href=\"$PHP_SELF?sort=restocked&lower=$lower&number=$number&desc=$desc\">Restocked&nbsp;&nbsp;</a></td>
...
<td><a href=\"%s?itemid=%s&sort=$sort&lower=$lower&number=$number&desc=$desc\">(EDIT)</a></td>
<td><a href=\"admintrackB.php?itemid=%s&sort=$sort&lower=$lower&number=$number&artist=$artist&desc=$desc\">(AUD)</a></td>
<td><a href=\"adminimage.php?itemid=%s&sort=$sort&lower=$lower&number=$number&artist=$artist&desc=$desc\">(IMG)</a></td>
<td><a href=\"adminorder_itemsB.php?itemid=%s&sort=$sort&lower=$lower&number=$number&artist=$artist&desc=$desc\">(ORDER)</a></td>
</tr>",
        $myrow["itemid"],$PHP_SELF,$myrow["itemid"],$myrow["itemid"],$myrow["itemid"],$myrow["itemid"]);

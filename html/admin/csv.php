	 ...
	 echo " <a href=\"$PHP_SELF?sort=$sort&lower=$lower&number=$number&desc=&nbsp;\">ASC</A>";
       ...
       else       
       {
		echo " <a href=\"$PHP_SELF?sort=$sort&lower=$lower&number=$number&desc=DESC\">DECENDING</a>";};
       	...
       	echo "<a href=\"$phpself?module=$module&sort=artist&lower=$lower&number=$number&desc=".!$desc."&mode=$mode";
       	...
       	echo "\">Label</a>, <a href=\"$phpself?module=$module&sort=format&lower=$lower&number=$number&desc=".!$desc;
         echo "\">Format</a>, <a href=\"$phpself?module=$module&sort=quantity&lower=$lower&number=$number&desc=".!$desc;
       	echo "\">Quantity</a>, <a href=\"$phpself?module=$module&module=$module&sort=retail&lower=$lower&number=$number&desc=".!$desc;
       	echo "\">Cost</a><br>\n";
      
       do
       {
        printf("<font color=000000>%s, %s, %s %s, %s, %s, %s<br>",$myrow["artist"], $myrow["title"], $myrow["label"], $myrow["catalog"], $myrow["format"],  $myrow['quantity'], $myrow['cost']); 

...
comments</a>";
    ...
    // print the list if there is not editing
     ...
     $result = mysql_query("SELECT * FROM comments, items WHERE comments.itemID=items.itemid ORDER BY commentID DESC");
...
<td>%s</td><td><a href=\"admincommentB.php?keywords=%s\">%s</a></td>
<td>%s</td><td>%s</td><td>%s</td><td>%s</td>",
        $myrow["commentID"],$myrow["itemid"],$myrow["artist"], $myrow["title"],
$myrow["label"],$myrow["format"],$myrow["username"],$myrow["message"], $myrow["keywords"],$myrow["keywords"],
